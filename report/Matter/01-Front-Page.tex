...
\begin{titlepage}
    ...
    \ifthenelse{\equal{\SchoolOption}{hcmus}}{
        \begin{figure}
            \includegraphics[width=0.485\linewidth]{Figures/Theme/Logotypes/HCMUS-Logo-Wide-B.pdf}
        \end{figure}
        \vspace{-1.8\baselineskip}
    }
    ...
    {\noindent\itshape\fontsize{10}{10}\selectfont Student ID: \GetFirstAuthorNumber}
